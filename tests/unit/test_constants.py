...
from bgp_test_framework.constants import (
    MARKER, BGP_PORT, MESSAGE_TYPES, MESSAGE_TYPE_NAMES,
    MESSAGE_MIN_LENGTHS, ORIGIN_TYPES, AS_PATH_SEGMENT_TYPES,
    PATH_ATTRIBUTE_FLAGS, PATH_ATTRIBUTE_TYPES, NOTIFICATION_ERROR_CODES,
    MESSAGE_HEADER_ERROR_SUBCODES, OPEN_MESSAGE_ERROR_SUBCODES,
    UPDATE_MESSAGE_ERROR_SUBCODES, WELL_KNOWN_MANDATORY_ATTRIBUTES,
    AFI_VALUES, SAFI_VALUES, CAPABILITY_CODES, BGP_FSM_STATES
)
